...
try { 
	...
	String ctNo = session.getId();
	 ...
	 String jsql5 = "delete from temcart where ctNo=?";    
	...
	String jsql = "insert into temcart (ctNo, prdNo, ctQty, memId) values (?,?,?,?)";  
...
<%
		String jsql2 = "select prdNo, ctQty from temcart where ctNo = ?";
...
<form name="form" id="form_buy" method="Post" action="directOrderOk.jsp">
...
<table id="orderMember">
	<tr>
		...
		<label for="pay"><input type="checkbox" name="bank" id="pay" class="kakao1" value="kakao"><span class="pay">KakaoPay</span></label>
