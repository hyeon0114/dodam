...
<div id = "mainTop">
	<ul>
		...
		<li><a href="center.jsp?id=<%=id%>"><b>고객센터</b></a></li>
	</ul>
</div>
...
<div id="notice_total">
<div id="notice_ctg">
	<div class="notice_menu">고객센터</div>
	<ul>
		<li class="clicked"><a href="notice.jsp">공지사항</a></li>
		<li><a href="inquiry.jsp">1:1 문의</a></li>
		<li><a href="qna.jsp">자주하는 질문</a></li>
	</ul>
</div>
...
$(document).ready(function() {
  ...
  $('#notice_ctg li a').click(function(e) {
    e.preventDefault();
...
<script>
const listItems = document.querySelectorAll('#notice_ctg li');
