...
<body>
<div id="detail">
<div class="notice_t">자주하는 질문</div>
  <%
       String DB_URL="jdbc:mysql://localhost:3306/dodam";  
       String DB_ID="root";  
	   ...
	   Class.forName("org.gjt.mm.mysql.Driver");  
		...
		String jsql = "select count(*) from qna WHERE qctg = ?";
		...
		String jsql2 = "select * from qna WHERE qctg = ? order by qdate desc";
  ...
  <div id="notice_list_t">
    ...
    %> 	   
 	   <tr class="bg_notice">
 	      ...
 	      <td>
			<a href="qna_view.jsp?no=<%=no%>"><%=no%></a>
 	      </td> 	      
 	      <td>
		  	<a href="qna_view.jsp?no=<%=no%>"><%=title%></a>
 	      </td>
 	      <td>
			<a href="qna_view.jsp?no=<%=no%>"><%=name%></a>
 	      </td>
		</a>
 	   </tr>  
   ...
   %>
     ...
     <div align="center">
		...
		%>
       <a href="qna.jsp?group_index=0"><font size=2>처음</font></a>
        &nbsp;&nbsp;&nbsp;
   ...
   <%
			...
			{
   %>
        <a href="qna.jsp?group_index=<%= j - 1 %>"><%= j %></a>
   <%
            }
       }
   %>
	  ...
	  <%
	   ...
	   %>
      <a href="qna.jsp?group_index=<%= cntList_1 - 1 %>"><font size=2>끝</font></a>
