...
<body>
  ...
  <%
	   ...
	   Class.forName("org.gjt.mm.mysql.Driver");  
		...
		String jsql = "select * from notice WHERE Nono=?";
		...
		String Nno = rs.getString("Nono");
		String title = rs.getString("NoTitle");
		String name = rs.getString("Noname");
		String content = rs.getString("Nocontent");
		String date = rs.getString("Nodate");
...
<div id="search_M3">
<div id="notice_line"><a href="notice.jsp">고객센터</a> > 공지사항</div>
...
<div id="back_href2">
	<nav class="back_href2">
		<ul>
			<li><a href="notice_view.jsp?no=<%=nom%>">< 이전</a></li>
			<li><a href="notice.jsp">목록</a></li>
			<li><a href="notice_view.jsp?no=<%=nop%>">다음 ></a></li>
		</ul>
	</nav>
</div>
